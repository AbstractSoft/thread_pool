...
- **Tests**: `tests/thread_pool_tests.cpp` — GoogleTest test suite (25 tests), fetched via FetchContent
...
- Version tag is `v1.0.5`; update `CMakeLists.txt` project version and git tag for new releases
